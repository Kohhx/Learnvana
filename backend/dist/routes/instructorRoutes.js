...
router.get("/classes/:classId/students/pending", protect, classController.getPendingStudentFromClass);

// Instructor approve student to class - POST
router.post("/classes/:classId/students/approve", protect, classController.approveStudentFromClass);

// Instructor reject student from class - POST
router.post("/classes/:classId/students/reject", protect, classController.rejectStudentFromClass);

// Instructor get student list from class - GET
router.get("/classes/:classId/students", protect, classController.getAllStudentsFromClass);

// Instructor delete class from class list - DELETE
router.post("/classes/delete", protect, instructorController.delete);

// Instructor delete student from class student list - DELETE
router.post("/classes/:classId/students/delete", protect, classController.deleteStudentFromClass);
...
router.post("/classes/:classId/lessons/create", protect, lessonController.createLesson);

// Get all lessons from a class
router.get("/classes/:classId/lessons", protect, lessonController.getClassLessons);

// Get one lesson from a class
router.get("/classes/:classId/lessons/:lessonId", protect, lessonController.getClassLesson);
