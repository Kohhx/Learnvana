...
router.get('/classes/:classId/lessons', protect, lessonController.getInstructorLessons)

// Get one instructor class
router.get('/classes/:classId/lessons/:lessonId', protect, lessonController.getInstructorLesson)
